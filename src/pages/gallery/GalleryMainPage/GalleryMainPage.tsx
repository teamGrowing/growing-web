...
import AlbumRowContainer from 'components/pages/gallery/AlbumRowContainer/AlbumRowContainer';
...
import GalleryTitle from 'components/pages/gallery/GalleryTitle/GalleryTitle';
